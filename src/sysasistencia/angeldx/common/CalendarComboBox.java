...
public class CalendarComboBox extends JComboBox {
  ...
  public CalendarComboBox(boolean showActualDate) {
    /* 'showActualDate': indica que, quando a caixa de texto for (re)inicializada, o campo deve ou nao exibir a data atual. */
    super();
  ...
  private class BasicDateComboBoxUI extends BasicComboBoxUI {
  ...
  private class DatePanel extends javax.swing.JPanel {
    ...
    public DatePanel() {
      ...
      month = new String[]{"Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre",
  ...
  public void updateUI() {
    ...
    } else if (comboBoxUI instanceof BasicComboBoxUI) {
      comboBoxUI = new BasicDateComboBoxUI();
    }
